({
    ...
    doInit : function(component, event, helper) {
        ...
        action.setParams({
            ...
            productStatus : component.get('v.ElevateBossProduct.ProductStatus__c'),
            productType : component.get('v.ElevateBossProduct.ProductType__c')
        });
            ...
            if (state === "SUCCESS") {
                ...
                if(response.getReturnValue() === true){
                    component.find('notifLib').showToast({
                        "variant": "success",
                        "message": $A.get("$Label.c.Apply_Discounts_Success_for_Elevate_Boss")
                    });
                }else{
                    component.find('notifLib').showToast({
                        "variant": "error",
