({
    ...
    gotoURL : function(component, event, helper) {
        var dynamicURL = $A.get("$Label.c.Communities_OfficeExclusives_URL");
   		window.open(dynamicURL+'customers/apex/Communities_OfficeExclusive?id='+component.get("v.subscriptionId"));
    },
    print : function(component, event, helper) {
        window.open('Communities_OE_Subscription_Print?id='+component.get("v.subscriptionId"));
    },
