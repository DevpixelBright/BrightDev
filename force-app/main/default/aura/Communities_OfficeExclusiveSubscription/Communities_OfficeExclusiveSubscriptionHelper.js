({
    ...
    convertArrayOfObjectsToCSV : function(component, sObjectList){
        ...
        var keys = ['propertyAddress','city','state','zip','submittedOnStr','submittedBy'];
        var headers = ['Property Address','City','State','Zip','Office Exclusive Date Submitted','Submitted by'];
        var csvString = '';
